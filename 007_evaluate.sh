...
python G:\Projects\models\research\object_detection\eval.py --logtostderr --pipeline_config_path=ssd_mobilenet_v1_windows.config  --checkpoint_dir=model_output --eval_dir=eval
